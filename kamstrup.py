...
if __name__ == "__main__":
        ...
        bad = 0
        while True:
                v1,u = foo.readvar(0x041e)
                time.sleep(1)
                c1,u = foo.readvar(0x0434)
                time.sleep(1)
                ...
                if v1 == None or c1 == None or p1 == None or e1 == None:
                        ...
                        e.append(e1)
                        plt.subplot(2, 2, 1)
                        plt.plot(t, v, 'ro-', linewidth=3.0)
                        plt.ylabel('Spænding [V]')
                        plt.gcf().axes[0].xaxis.set_major_formatter(hfmt)
                        plt.gcf().axes[0].set_ylim([200, 250])
                        plt.subplot(2, 2, 2)
                        plt.plot(t, c, 'bo-', linewidth=3.0)
                        plt.ylabel('Strøm [A]')
                        plt.gcf().axes[1].xaxis.set_major_formatter(hfmt)
                        plt.gcf().axes[1].set_ylim([0, 4])
                        plt.subplot(2, 2, 3)
                        ...
                        plt.gcf().axes[3].xaxis.set_major_formatter(hfmt)
                        plt.gcf().axes[3].set_autoscaley_on(True)
                        plt.gcf().axes[3].set_ylim(bottom=100000)
